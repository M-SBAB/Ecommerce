  ...
  return (
    <div className='fixed top-0 left-0 lg:left-[300px] right-0 z-40 bg-white shadow-md border-b border-gray-200'>
      <div className='flex items-center justify-between px-4 sm:px-6 py-2'>
        ...
        <button
          onClick={onMenuClick}
          className='lg:hidden p-2 rounded hover:bg-primary-50 transition-colors duration-200'
        ...
        {user && (
          <div className='flex items-center gap-2 sm:gap-4'>
            <div className='hidden sm:flex items-center gap-2 px-4 py-2 bg-primary-50 rounded border border-primary-100'>
            ...
            {isUser() && (
              <button
                ...
                className='relative p-2 sm:p-3 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded transition-colors duration-200 shadow-sm hover:shadow-md'
