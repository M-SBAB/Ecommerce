  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={onClose}
          className='lg:hidden absolute top-4 right-4 text-slate-400 hover:text-white transition-colors duration-200 z-10'
        ...
        {/* Header */}
        <div className='border-b border-slate-700 pt-2'>
            ...
            {navigationLinks.map((link) => (
              <li key={link.path}>
                <Link
                  to={link.path}
                  onClick={() => onClose()}
                  className='flex items-center px-4 py-3 mx-2 text-slate-300 hover:bg-slate-700 hover:text-white rounded-lg transition-all duration-200 ease-in-out'
                >
        ...
        {/* Logout Button */}
        <div className='px-3 lg:px-4 py-4 border-t border-slate-700'>
          <button
            onClick={handleLogout}
            className='flex items-center justify-center w-full px-4 py-3 mx-2 text-slate-300 hover:bg-red-600 hover:text-white rounded-lg transition-all duration-200 ease-in-out font-medium'
          >
