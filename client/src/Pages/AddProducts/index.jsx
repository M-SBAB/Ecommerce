...
const addProduct  = async(data)=>{
          const res = await fetch ("http://localhost:5000/products/add",{
              ...
              body:JSON.stringify({productName:data.addProductName,category:data.addProductCategory,
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Add product details to inventory</p>
            </div>
          </div>
